  ...
  const addEditFabrication = () => {
    ...
    <div style={{
      ...
      {attendanceRecords.length === 0 ? (
        <div style={{ color: "#888", textAlign: "center", marginTop: 40 }}>No attendance records found.</div>
      ) : (
            ...
            {editingAttendanceId === record.id && editingCategory === "site" && (
              <div style={{ margin: "10px 0" }}>
                ...
                {editingRecord.site.map((site, idx) => {
                  // Get unavailable workers/vehicles for this site (optional: for filtering)
                  return (
